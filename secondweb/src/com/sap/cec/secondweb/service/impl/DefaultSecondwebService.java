...
public class DefaultSecondwebService implements SecondwebService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSecondwebService.class);
	...
	{
		return DefaultSecondwebService.class.getResourceAsStream("/secondweb/sap-hybris-platform.png");
	}
