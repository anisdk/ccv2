...
public class DefaultWrokaroundService implements WrokaroundService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultWrokaroundService.class);
	...
	{
		return DefaultWrokaroundService.class.getResourceAsStream("/wrokaround/sap-hybris-platform.png");
	}
