...
public class DefaultWrofixService implements WrofixService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultWrofixService.class);
	...
	{
		return DefaultWrofixService.class.getResourceAsStream("/wrofix/sap-hybris-platform.png");
	}
