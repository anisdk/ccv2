 ...
 */
package org.customstorefront.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(CustomstorefrontFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(CustomstorefrontFulfilmentProcessConstants.PARENT_PROCESS);
