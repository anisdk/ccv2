...
import org.customstorefront.fulfilmentprocess.test.actions.TestActionTemp;
...
public class PaymentIntegrationTest extends ServicelayerTest
{
	...
	public static void prepare() throws Exception
	{
		...
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/customstorefrontfulfilmentprocess/test/customstorefrontfulfilmentprocess-spring-test.xml"));
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/customstorefrontfulfilmentprocess/test/customstorefrontfulfilmentprocess-spring-test-fraudcheck.xml"));
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/customstorefrontfulfilmentprocess/test/process/order-process-spring.xml"));
		...
		definitonFactory.add("classpath:/customstorefrontfulfilmentprocess/test/process/payment-process.xml");
	...
	public void setUpProductCatalogue()
	{
		try
		{
			...
			importCsv("/customstorefrontfulfilmentprocess/test/testBasics.csv", "windows-1252");
			importCsv("/customstorefrontfulfilmentprocess/test/testCatalog.csv", "windows-1252");
	...
	public static void removeProcessDefinitions()
	{
		...
		final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/customstorefrontfulfilmentprocess/test/customstorefrontfulfilmentprocess-spring-testcleanup.xml"));
