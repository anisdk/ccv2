 ...
 */
package org.customstorefront.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, CustomstorefrontFulfilmentProcessConstants.PARENT_PROCESS);
