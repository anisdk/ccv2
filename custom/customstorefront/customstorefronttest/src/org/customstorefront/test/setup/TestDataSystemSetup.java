 ...
 */
package org.customstorefront.test.setup;
...
import org.customstorefront.test.constants.CustomstorefrontTestConstants;
import org.customstorefront.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = CustomstorefrontTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/customstorefronttest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/customstorefronttest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/customstorefronttest/import/cstickets.impex");
			...
			importImpexFile(context, "/customstorefronttest/import/csquotes.impex");
		}
	}
}
