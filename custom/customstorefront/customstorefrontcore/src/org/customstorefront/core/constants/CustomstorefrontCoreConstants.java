 ...
 */
package org.customstorefront.core.constants;

/**
 * Global class for all CustomstorefrontCore constants. You can add global constants for your extension into this class.
 */
public final class CustomstorefrontCoreConstants extends GeneratedCustomstorefrontCoreConstants
{
	public static final String EXTENSIONNAME = "customstorefrontcore";


	private CustomstorefrontCoreConstants()
	{
		//empty
	}
