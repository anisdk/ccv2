 ...
 */
package org.customstorefront.core.suggestion;
...
import org.customstorefront.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/customstorefrontcore/test/testSimpleSuggestionService.csv", "utf-8");
	}
