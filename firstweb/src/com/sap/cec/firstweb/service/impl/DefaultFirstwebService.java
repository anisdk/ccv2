...
public class DefaultFirstwebService implements FirstwebService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultFirstwebService.class);
	...
	{
		return DefaultFirstwebService.class.getResourceAsStream("/firstweb/sap-hybris-platform.png");
	}
