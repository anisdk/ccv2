...
public class DefaultCustomcoreService implements CustomcoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCustomcoreService.class);
	...
	{
		return DefaultCustomcoreService.class.getResourceAsStream("/customcore/sap-hybris-platform.png");
	}
