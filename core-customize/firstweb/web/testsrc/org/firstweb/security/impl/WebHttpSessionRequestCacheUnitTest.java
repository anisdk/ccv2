...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/firstweb/electronics/en",
						"https://electronics.local:9002/firstweb/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/firstweb/electronics/en",
						"https://electronics.local:9002/firstweb/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/firstweb/electronics/ja/Y/Z",
						"https://electronics.local:9002/firstweb/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/firstweb/electronics/en",
						"https://electronics.local:9002/firstweb/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/firstweb",
						"https://electronics.local:9002/firstweb"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/firstweb",
						"https://electronics.local:9002/firstweb/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/firstweb/electronics/en",
						"https://electronics.local:9002/firstweb/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
