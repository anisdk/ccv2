...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/thirdweb/electronics/en",
						"https://electronics.local:9002/thirdweb/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/thirdweb/electronics/en",
						"https://electronics.local:9002/thirdweb/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/thirdweb/electronics/ja/Y/Z",
						"https://electronics.local:9002/thirdweb/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/thirdweb/electronics/en",
						"https://electronics.local:9002/thirdweb/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/thirdweb",
						"https://electronics.local:9002/thirdweb"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/thirdweb",
						"https://electronics.local:9002/thirdweb/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/thirdweb/electronics/en",
						"https://electronics.local:9002/thirdweb/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
