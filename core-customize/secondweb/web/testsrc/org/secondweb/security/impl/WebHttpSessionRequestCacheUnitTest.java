...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/secondweb/electronics/en",
						"https://electronics.local:9002/secondweb/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/secondweb/electronics/en",
						"https://electronics.local:9002/secondweb/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/secondweb/electronics/ja/Y/Z",
						"https://electronics.local:9002/secondweb/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/secondweb/electronics/en",
						"https://electronics.local:9002/secondweb/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/secondweb",
						"https://electronics.local:9002/secondweb"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/secondweb",
						"https://electronics.local:9002/secondweb/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/secondweb/electronics/en",
						"https://electronics.local:9002/secondweb/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
