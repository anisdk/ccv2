...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/fourthweb/electronics/en",
						"https://electronics.local:9002/fourthweb/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/fourthweb/electronics/en",
						"https://electronics.local:9002/fourthweb/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/fourthweb/electronics/ja/Y/Z",
						"https://electronics.local:9002/fourthweb/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/fourthweb/electronics/en",
						"https://electronics.local:9002/fourthweb/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/fourthweb",
						"https://electronics.local:9002/fourthweb"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/fourthweb",
						"https://electronics.local:9002/fourthweb/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/fourthweb/electronics/en",
						"https://electronics.local:9002/fourthweb/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
